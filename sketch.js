...
function setup() {
	...
	rope1=new Rope(bobObject1.body,roofObject.body,-bobDiamater*2,0);
	rope2=new Rope(bobObject2.body,roofObject.body,-bobDiamater*2,0);
	...
	rope5=new Rope(bobObject5.body,roofObject.body,-bobDiamater*2,0);
